...
function SetContextMenus() {
	...
	ContextManager.AddItem(i, { text:'pack', click: () => OpenPacking(ContextManager.save[2], ContextManager.save[3]) })
	ContextManager.AddItem(i, { text:'unpack', click: () => UnPack(ContextManager.save[3]) })
	ContextManager.AddItem(i, { text:'editpack', click: () => EditPack(ContextManager.save[3]) })
